// Origin from https://www.thingiverse.com/thing:8443
...
// Modules
//=======================================
// c - ControlPoints (4 points)
module BezQuadCurve(c, focalPoint=gFocalPoint, steps=gSteps, height=gHeight, debug=false)
{
	if (debug) {
  	// Draw control points
		for(point=[0:3]) {
